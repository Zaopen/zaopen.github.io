...
```md
![inline](http://xx.com/xx.jpg)
上方[inline]对应了html网页<a>元素里的"alt"属性，模版里css对"alt=inline"添加了行内属性。
```
...
![The Legend of Zelda: Twilight Princess](zelda.jpg)
